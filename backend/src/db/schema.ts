import { integer, pgTable,text,uuid, timestamp ,  boolean ,jsonb} from "drizzle-orm/pg-core";
...
// cascade = "delete children when parent is deleted "; restict ="don't delete the parent if any child still points at it ".
